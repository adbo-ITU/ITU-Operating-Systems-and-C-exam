...
\begin{enumerate}
  \item Pop the top of the stack into the \texttt{\%rax} register. This instruction is encoded as \code{58}\footnote{Source: \url{https://github.itu.dk/pages/OSC/22-Website/labs/attacklab.pdf}}, and I found two viable gadgets as follows:
  ...
  \item Copy the contents of register \texttt{\%rax} into register \texttt{\%rdi} (because \texttt{\%rdi} holds the first argument to a function). This instruction is encoded as the multibyte sequence \code{48 89 c7}. A usable gadget can be found as follows:
